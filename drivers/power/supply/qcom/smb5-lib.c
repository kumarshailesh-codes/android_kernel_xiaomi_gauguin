				  ...
				  const union power_supply_propval *val)
{
	...
	if (val->intval == 1) {
		// Standard Suspend: suspend USB and DC inputs completely (runs 100% off battery)
		...
		// Motherboard Bypass Charging: stop battery charging but keep USB/DC inputs active!
